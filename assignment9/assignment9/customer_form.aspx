<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customer_form.aspx.cs" Inherits="assignment9.customer_form" %>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td>
                    ...
                    <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="TxtName" ErrorMessage="Name must have atleast 6 Characters" ForeColor="Red" OnServerValidate="CustomValidator1_ServerValidate"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
